...
module {
    func.func @sibling_fusion(%arg0: memref<10x10xf32>, %arg1: memref<10x10xf32>,
        ...
        %l2 = allo.create_loop_handle %s1, "k"
        %l3 = allo.create_loop_handle %s2, "i1"
        %l4 = allo.create_loop_handle %s2, "k1"
    ...
    func.func @matrix_multiply( %A: memref<1024x1024xf32>, %B: memref<1024x1024xf32>, %C: memref<1024x1024xf32>, %D: memref<1024x1024xf32>)
    {
        ...
        %l4 = allo.create_loop_handle %s2, "i1"
        %l5 = allo.create_loop_handle %s2, "j1"
        %l6 = allo.create_loop_handle %s2, "k1"
        // C=A*B
        ...
        allo.compute_at (%s1, %s2, %l6)
        return
    }
    func.func @no_load() -> (memref<10x10xi32>, memref<10x10xi32>) {
        %3 = allo.create_op_handle "A"
        %0 = allo.create_loop_handle %3, "y"
        %1 = allo.create_loop_handle %3, "x"
        ...
        %7 = allo.create_op_handle "B"
        %4 = allo.create_loop_handle %7, "y"
        %5 = allo.create_loop_handle %7, "x"
