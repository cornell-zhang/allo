...
module {
    allo.customization @gemm_opt(
        %A: memref<?x?x!allo.Type>,
        %B: memref<?x?x!allo.Type>,
        %C: memref<?x?x!allo.Type>,
        %s: !allo.OpHandle,
        %i: !allo.LoopHandle,
        %j: !allo.LoopHandle,
        %k: !allo.LoopHandle
        ...
        allo.pipeline(%j, 1)
        allo.partition(%A: memref<?x?x!allo.Type>, "CompletePartition", 2)
        allo.partition(%B: memref<?x?x!allo.Type>, "CompletePartition", 2)
        allo.partition(%C: memref<?x?x!allo.Type>, "CompletePartition", 2)
        allo.end
    }
    func.func @top(%A: memref<64x32xi32>, %B: memref<32x64xi32>, %C: memref<64x64xi32>) -> memref<64x64xi32>
    {
        ...
        allo.apply @gemm_opt(%A, %B, %D, %s1, %i1, %j1, %k1) : (memref<64x32xi32>, memref<32x64xi32>, memref<64x64xi32>, !allo.OpHandle, !allo.LoopHandle, !allo.LoopHandle, !allo.LoopHandle) -> ()
        allo.apply @gemm_opt(%C, %D, %E, %s2, %i2, %j2, %k2) : (memref<64x64xi32>, memref<64x64xi32>, memref<64x64xi32>, !allo.OpHandle, !allo.LoopHandle, !allo.LoopHandle, !allo.LoopHandle) -> ()
