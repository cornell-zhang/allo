...
module {
  ...
  func.func private @fc1(memref<1x400xi8>, memref<120x400xf32>, memref<1x120xf32>) -> memref<1x120x!allo.Fixed<8, 4>>
  func.func private @relu_2(memref<1x120x!allo.Fixed<8, 4>>) -> memref<1x120x!allo.Fixed<8, 4>>
  func.func private @fc2(memref<1x120x!allo.Fixed<8, 4>>, memref<84x120xf32>, memref<1x84xf32>) -> memref<1x84x!allo.Fixed<8, 4>>
  func.func private @relu_3(memref<1x84x!allo.Fixed<8, 4>>) -> memref<1x84x!allo.Fixed<8, 4>>
  func.func private @fc3(memref<1x84x!allo.Fixed<8, 4>>, memref<10x84xf32>, memref<1x10xf32>) -> memref<1x10xf32>
  func.func @main() {
    ...
    %16 = call @fc1(%15, %3, %4) : (memref<1x400xi8>, memref<120x400xf32>, memref<1x120xf32>) -> memref<1x120x!allo.Fixed<8, 4>>
    // CHECK: call @fc1(%6, %alloc_2, %alloc_3) : (memref<1x400xi8>, memref<120x400xf32>, memref<1x120xf32>) -> memref<1x120xi8>
    %17 = call @relu_2(%16) : (memref<1x120x!allo.Fixed<8, 4>>) -> memref<1x120x!allo.Fixed<8, 4>>
    // CHECK: call @relu_2(%7) : (memref<1x120xi8>) -> memref<1x120xi8>
    %18 = call @fc2(%17, %5, %6) : (memref<1x120x!allo.Fixed<8, 4>>, memref<84x120xf32>, memref<1x84xf32>) -> memref<1x84x!allo.Fixed<8, 4>>
    // CHECK: call @fc2(%8, %alloc_4, %alloc_5) : (memref<1x120xi8>, memref<84x120xf32>, memref<1x84xf32>) -> memref<1x84xi8>
    %19 = call @relu_3(%18) : (memref<1x84x!allo.Fixed<8, 4>>) -> memref<1x84x!allo.Fixed<8, 4>>
    // CHECK: call @relu_3(%9) : (memref<1x84xi8>) -> memref<1x84xi8>
    %20 = call @fc3(%19, %7, %8) : (memref<1x84x!allo.Fixed<8, 4>>, memref<10x84xf32>, memref<1x10xf32>) -> memref<1x10xf32>
