...
module {
  func.func @conv_interleaving_accu(%Input: memref<32x32xf32>, %Kernel: memref<3x3xf32>, %Output: memref<30x30xf32>)
  {
    ...
    %lry = allo.create_loop_handle %s, "ry"
    %lrx = allo.create_loop_handle %s, "rx"
    ...
    allo.reorder(%lry, %lrx, %lj)
    %buf = allo.buffer_at(%Output: memref<30x30xf32>, %li) -> memref<30xf32>
    return
  }
  func.func @conv2d_interleaving_accu(%Input: memref<3x32x32xf32>, %Kernel: memref<6x3x3x3xf32>, %Output: memref<6x30x30xf32>)
  {
    %s = allo.create_op_handle "s"
    %loc = allo.create_loop_handle %s, "oc"
    %li = allo.create_loop_handle  %s, "i"
    %lj = allo.create_loop_handle  %s, "j"
    %lrc = allo.create_loop_handle %s, "rc"
    %lry = allo.create_loop_handle %s, "ry"
    %lrx = allo.create_loop_handle %s, "rx"
    ...
    allo.reorder(%lrc, %lry, %lrx, %lj)
    %buf = allo.buffer_at(%Output: memref<6x30x30xf32>, %li) -> memref<30xf32>
    return
  }
  func.func @conv2d_default_buf(%Input: memref<3x32x32xf32>, %Kernel: memref<6x3x3x3xf32>, %Output: memref<6x30x30xf32>)
  {
    ...
    %buf = allo.buffer_at(%Output: memref<6x30x30xf32>, %lj) -> memref<1xf32>
    return
  }
  func.func @conv2d_buffer_at_0(%Input: memref<3x32x32xf32>, %Kernel: memref<6x3x3x3xf32>, %Output: memref<6x30x30xf32>)
  {
    ...
    %buf = allo.buffer_at(%Output: memref<6x30x30xf32>, %loc) -> memref<30x30xf32>
    return
  }
  func.func @conv2d_buffer_at_0_interleaving(%Input: memref<3x32x32xf32>, %Kernel: memref<6x3x3x3xf32>, %Output: memref<6x30x30xf32>)
  {
    ...
    allo.reorder(%lrc, %lry, %lrx, %li, %lj)
    %buf = allo.buffer_at(%Output: memref<6x30x30xf32>, %loc) -> memref<30x30xf32>
    return
  }
}