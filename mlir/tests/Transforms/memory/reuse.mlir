...
module {
    func.func @blur(%A: memref<10x10xf32>, %B: memref<10x8xf32>)
    {
        ...
        %buf = allo.reuse_at(%A: memref<10x10xf32>, %lj) -> memref<3xf32>
        return
    }
    func.func @blur5(%A: memref<10x10xf32>, %B: memref<10x5xf32>)
    {
        ...
        %buf = allo.reuse_at(%A: memref<10x10xf32>, %lj) -> memref<5xf32>
        return
    }
    func.func @blur_x(%A: memref<10x10xf32>, %B: memref<8x10xf32>)
    {
        ...
        %buf = allo.reuse_at(%A: memref<10x10xf32>, %li) -> memref<3x10xf32>
        return
    }
    ...
    func.func @conv2d(%A: memref<10x10xf32>, %B: memref<8x8xf32>)
    {
        ...
        %buf = allo.reuse_at(%A: memref<10x10xf32>, %li) -> memref<3x10xf32>
        allo.partition(%buf: memref<3x10xf32>, "CompletePartition", 1)
        return
    }
}