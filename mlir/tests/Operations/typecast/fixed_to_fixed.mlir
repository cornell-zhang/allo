...
module {
  ...
  func.func @top() -> () {
    ...
    %1 = memref.alloc() : memref<2x2x!allo.Fixed<16,1>>
    affine.for %arg0 = 0 to 2 {
      affine.for %arg1 = 0 to 2 {
        %3 = affine.load %0[%arg0, %arg1] : memref<2x2x!allo.Fixed<32,2>>
        %4 = allo.fixed_to_fixed (%3) : !allo.Fixed<32, 2> -> !allo.Fixed<16, 1>
        affine.store %4, %1[%arg0, %arg1] : memref<2x2x!allo.Fixed<16,1>>
      }
    }
    allo.print_memref(%1) {format = "%.2f \n"} : memref<2x2x!allo.Fixed<16,1>> 
    return
  }
}
