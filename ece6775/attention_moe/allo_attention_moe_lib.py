...
def optimize_attention_moe_with_composition(
    ...
    s_linear_fc1 = allo.customize(allo_nn.linear2d, instantiate=[Ty, Ty, Ty, L, D_hidden, D])
    s_gelu = allo.customize(allo_nn.GeLU, instantiate=[Ty, L, D_hidden])
    s_linear_fc2 = allo.customize(allo_nn.linear2d, instantiate=[Ty, Ty, Ty, L, D, D_hidden])
