...
int main() {
    ...
    block.v1_in.push_input(5);
    block.v1_in.push_input(6);
    block.v1_in.push_input(7);
    block.v1_in.push_input(8);
    block.v1_in.push_input(9);
    block.v1_in.push_input(10);
    block.v1_in.push_input(11);
    block.v1_in.push_input(12);
    block.v1_in.push_input(13);
    block.v1_in.push_input(14);
    block.v1_in.push_input(15);
