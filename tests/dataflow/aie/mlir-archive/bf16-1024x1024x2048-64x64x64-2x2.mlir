module {
  aie.device(npu1_4col) {
    ...
    aiex.runtime_sequence(%arg0: memref<1024x2048xbf16>, %arg1: memref<2048x1024xbf16>, %arg2: memref<1024x1024xbf16>) {
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][8, 32, 64, 64][0, 64, 2048, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_1} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 262144][8, 32, 64, 64][0, 64, 2048, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_1} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 524288][8, 32, 64, 64][0, 64, 2048, 1]) {id = 7 : i64, issue_token = true, metadata = @fifo_1} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 786432][8, 32, 64, 64][0, 64, 2048, 1]) {id = 10 : i64, issue_token = true, metadata = @fifo_1} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 1048576][8, 32, 64, 64][0, 64, 2048, 1]) {id = 13 : i64, issue_token = true, metadata = @fifo_1} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 131072][8, 32, 64, 64][0, 64, 2048, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_3} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 393216][8, 32, 64, 64][0, 64, 2048, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_3} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 655360][8, 32, 64, 64][0, 64, 2048, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_3} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 917504][8, 32, 64, 64][0, 64, 2048, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_3} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 1179648][8, 32, 64, 64][0, 64, 2048, 1]) {id = 5 : i64, issue_token = true, metadata = @fifo_3} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_5} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_5} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_5} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_5} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 5 : i64, issue_token = true, metadata = @fifo_5} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_7} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_7} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_7} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_7} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 5 : i64, issue_token = true, metadata = @fifo_7} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][8, 2, 64, 64][128, 64, 1024, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_10} : memref<1024x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 131072][8, 2, 64, 64][128, 64, 1024, 1]) {id = 5 : i64, issue_token = true, metadata = @fifo_10} : memref<1024x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 262144][8, 2, 64, 64][128, 64, 1024, 1]) {id = 8 : i64, issue_token = true, metadata = @fifo_10} : memref<1024x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 393216][8, 2, 64, 64][128, 64, 1024, 1]) {id = 11 : i64, issue_token = true, metadata = @fifo_10} : memref<1024x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 524288][8, 2, 64, 64][128, 64, 1024, 1]) {id = 14 : i64, issue_token = true, metadata = @fifo_10} : memref<1024x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 65536][8, 2, 64, 64][128, 64, 1024, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_13} : memref<1024x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 196608][8, 2, 64, 64][128, 64, 1024, 1]) {id = 6 : i64, issue_token = true, metadata = @fifo_13} : memref<1024x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 327680][8, 2, 64, 64][128, 64, 1024, 1]) {id = 9 : i64, issue_token = true, metadata = @fifo_13} : memref<1024x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 458752][8, 2, 64, 64][128, 64, 1024, 1]) {id = 12 : i64, issue_token = true, metadata = @fifo_13} : memref<1024x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 589824][8, 2, 64, 64][128, 64, 1024, 1]) {id = 15 : i64, issue_token = true, metadata = @fifo_13} : memref<1024x1024xbf16>
      ...
      aiex.npu.dma_wait {symbol = @fifo_13}
      aiex.npu.dma_wait {symbol = @fifo_13}
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 1310720][8, 32, 64, 64][0, 64, 2048, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_1} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 1572864][8, 32, 64, 64][0, 64, 2048, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_1} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 1835008][8, 32, 64, 64][0, 64, 2048, 1]) {id = 7 : i64, issue_token = true, metadata = @fifo_1} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 1441792][8, 32, 64, 64][0, 64, 2048, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_3} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 1703936][8, 32, 64, 64][0, 64, 2048, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_3} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 1966080][8, 32, 64, 64][0, 64, 2048, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_3} : memref<1024x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_5} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_5} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_5} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_7} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_7} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][8, 32, 64, 64][128, 65536, 1024, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_7} : memref<2048x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 655360][8, 2, 64, 64][128, 64, 1024, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_10} : memref<1024x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 786432][8, 2, 64, 64][128, 64, 1024, 1]) {id = 5 : i64, issue_token = true, metadata = @fifo_10} : memref<1024x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 917504][8, 2, 64, 64][128, 64, 1024, 1]) {id = 8 : i64, issue_token = true, metadata = @fifo_10} : memref<1024x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 720896][8, 2, 64, 64][128, 64, 1024, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_13} : memref<1024x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 851968][8, 2, 64, 64][128, 64, 1024, 1]) {id = 6 : i64, issue_token = true, metadata = @fifo_13} : memref<1024x1024xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 983040][8, 2, 64, 64][128, 64, 1024, 1]) {id = 9 : i64, issue_token = true, metadata = @fifo_13} : memref<1024x1024xbf16>
      aiex.npu.dma_wait {symbol = @fifo_10}
      aiex.npu.dma_wait {symbol = @fifo_10}
      aiex.npu.dma_wait {symbol = @fifo_10}
      aiex.npu.dma_wait {symbol = @fifo_13}
