module {
  aie.device(npu1_4col) {
    ...
    aiex.runtime_sequence(%arg0: memref<512x2048xbf16>, %arg1: memref<2048x512xbf16>, %arg2: memref<512x512xbf16>) {
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][4, 32, 64, 64][0, 64, 2048, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_1} : memref<512x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 262144][4, 32, 64, 64][0, 64, 2048, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_1} : memref<512x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 524288][4, 32, 64, 64][0, 64, 2048, 1]) {id = 7 : i64, issue_token = true, metadata = @fifo_1} : memref<512x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 786432][4, 32, 64, 64][0, 64, 2048, 1]) {id = 10 : i64, issue_token = true, metadata = @fifo_1} : memref<512x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 131072][4, 32, 64, 64][0, 64, 2048, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_3} : memref<512x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 393216][4, 32, 64, 64][0, 64, 2048, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_3} : memref<512x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 655360][4, 32, 64, 64][0, 64, 2048, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_3} : memref<512x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 917504][4, 32, 64, 64][0, 64, 2048, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_3} : memref<512x2048xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][4, 32, 64, 64][128, 32768, 512, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_5} : memref<2048x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][4, 32, 64, 64][128, 32768, 512, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_5} : memref<2048x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][4, 32, 64, 64][128, 32768, 512, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_5} : memref<2048x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][4, 32, 64, 64][128, 32768, 512, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_5} : memref<2048x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][4, 32, 64, 64][128, 32768, 512, 1]) {id = 1 : i64, issue_token = true, metadata = @fifo_7} : memref<2048x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][4, 32, 64, 64][128, 32768, 512, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_7} : memref<2048x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][4, 32, 64, 64][128, 32768, 512, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_7} : memref<2048x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 64][4, 32, 64, 64][128, 32768, 512, 1]) {id = 4 : i64, issue_token = true, metadata = @fifo_7} : memref<2048x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][4, 2, 64, 64][128, 64, 512, 1]) {id = 2 : i64, issue_token = true, metadata = @fifo_10} : memref<512x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 65536][4, 2, 64, 64][128, 64, 512, 1]) {id = 5 : i64, issue_token = true, metadata = @fifo_10} : memref<512x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 131072][4, 2, 64, 64][128, 64, 512, 1]) {id = 8 : i64, issue_token = true, metadata = @fifo_10} : memref<512x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 196608][4, 2, 64, 64][128, 64, 512, 1]) {id = 11 : i64, issue_token = true, metadata = @fifo_10} : memref<512x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 32768][4, 2, 64, 64][128, 64, 512, 1]) {id = 3 : i64, issue_token = true, metadata = @fifo_13} : memref<512x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 98304][4, 2, 64, 64][128, 64, 512, 1]) {id = 6 : i64, issue_token = true, metadata = @fifo_13} : memref<512x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 163840][4, 2, 64, 64][128, 64, 512, 1]) {id = 9 : i64, issue_token = true, metadata = @fifo_13} : memref<512x512xbf16>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 229376][4, 2, 64, 64][128, 64, 512, 1]) {id = 12 : i64, issue_token = true, metadata = @fifo_13} : memref<512x512xbf16>
