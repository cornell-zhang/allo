...
void kernel_0_0(
  ...
  l_S_k_0_k: for (int k = 0; k < 2; k++) {	// L4
...
void kernel_1_0(
  hls::stream< int8_t > &v21 /* v21[2] */,
  hls::stream< int8_t > &v22 /* v22[2] */,
  hls::stream< int8_t > &v23 /* v23[2] */,
  hls::stream< int8_t > &v24 /* v24[2] */,
  int16_t v25[2][2],
  int v26,
  int v27
) {	// L26
  ...
  l_S_k_0_k1: for (int k1 = 0; k1 < 2; k1++) {	// L27
...
void kernel_0_1(
  hls::stream< int8_t > &v42 /* v42[2] */,
  hls::stream< int8_t > &v43 /* v43[2] */,
  hls::stream< int8_t > &v44 /* v44[2] */,
  hls::stream< int8_t > &v45 /* v45[2] */,
  int16_t v46[2][2],
  int v47,
  int v48
) {	// L49
  ...
  l_S_k_0_k2: for (int k2 = 0; k2 < 2; k2++) {	// L50
...
void kernel_1_1(
  hls::stream< int8_t > &v63 /* v63[2] */,
  hls::stream< int8_t > &v64 /* v64[2] */,
  hls::stream< int8_t > &v65 /* v65[2] */,
  hls::stream< int8_t > &v66 /* v66[2] */,
  int16_t v67[2][2],
  int v68,
  int v69
) {	// L72
  ...
  l_S_k_0_k3: for (int k3 = 0; k3 < 2; k3++) {	// L73
...
void systolic_array(
  ...
  l_data_load_k4: for (int k4 = 0; k4 < 2; k4++) {	// L98
    l_S_m_0_m: for (int m = 0; m < 2; m++) {	// L99
      int8_t v91 = v84[m][k4];	// L100
      A_fifo[m][0].write(v91); // A_fifo[m][0][k4] = v91;	// L101
    }
    l_S_n_1_n: for (int n = 0; n < 2; n++) {	// L103
  ...
  l_data_drain_k5: for (int k5 = 0; k5 < 2; k5++) {	// L140
    l_S_m_4_m1: for (int m1 = 0; m1 < 2; m1++) {	// L141
      int8_t v114 = A_fifo[m1][2].read(); // A_fifo[m1][2][k5];	// L142
      A_drain[m1] = v114;	// L143
    }
    l_S_n_5_n1: for (int n1 = 0; n1 < 2; n1++) {	// L145
