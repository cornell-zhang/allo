...
def stencil3d(
    C: int32[2], orig: int32[row_size, col_size, height_size]
) -> int32[row_size, col_size, height_size]:
...
if __name__ == "__main__":
    ...
    np_orig = np.random.randint(0, 100, (row_size, col_size, height_size)).astype(
        np.int32
    )
