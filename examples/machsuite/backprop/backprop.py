...
def soft_max(net_outputs: float32[POSSIBLE_OUTPUTS], activations: float32[POSSIBLE_OUTPUTS]):
    total: float32 = 0.0
...
def RELU_NPL(activations: float32[NODES_PER_LAYER], dactivations: float32[NODES_PER_LAYER]):
    for i in range(NODES_PER_LAYER):
        dactivations[i] = activations[i] * (1.0 - activations[i])
        activations[i] = 1.0 / (1.0 + allo.exp(-activations[i]))

def RELU_PO(activations: float32[POSSIBLE_OUTPUTS], dactivations: float32[POSSIBLE_OUTPUTS]):
    for i in range(POSSIBLE_OUTPUTS):
        dactivations[i] = activations[i] * (1.0 - activations[i])
        activations[i] = 1.0 / (1.0 + allo.exp(-activations[i]))


def add_bias_to_activations_NPL(biases: float32[NODES_PER_LAYER], activations: float32[NODES_PER_LAYER]):
    for i in range(NODES_PER_LAYER):
        activations[i] = activations[i] + biases[i]


def add_bias_to_activations_PO(biases: float32[POSSIBLE_OUTPUTS], activations: float32[POSSIBLE_OUTPUTS]):
    for i in range(POSSIBLE_OUTPUTS):
        activations[i] = activations[i] + biases[i]


def matrix_vector_product_with_bias_input_layer(
    biases: float32[NODES_PER_LAYER], weights: float32[INPUT_DIMENSION * NODES_PER_LAYER],
    activations: float32[NODES_PER_LAYER], input_sample: float32[INPUT_DIMENSION]):
...
def matrix_vector_product_with_bias_second_layer(
    biases: float32[NODES_PER_LAYER], weights: float32[NODES_PER_LAYER * NODES_PER_LAYER],
    activations: float32[NODES_PER_LAYER], input_activations: float32[NODES_PER_LAYER]):
...
def matrix_vector_product_with_bias_output_layer(
    biases: float32[POSSIBLE_OUTPUTS], weights: float32[NODES_PER_LAYER * POSSIBLE_OUTPUTS],
    activations: float32[POSSIBLE_OUTPUTS], input_activations: float32[NODES_PER_LAYER]):
...
def take_difference(
    net_outputs: float32[POSSIBLE_OUTPUTS], solutions: float32[POSSIBLE_OUTPUTS],
    output_difference: float32[POSSIBLE_OUTPUTS], dactivations: float32[POSSIBLE_OUTPUTS]):
...
def get_delta_matrix_weights3(
    ...
    output_difference: float32[POSSIBLE_OUTPUTS], last_activations: float32[NODES_PER_LAYER]):
...
def get_oracle_activations2(
    weights3: float32[NODES_PER_LAYER * POSSIBLE_OUTPUTS], output_differences: float32[POSSIBLE_OUTPUTS],
    oracle_activations: float32[NODES_PER_LAYER], dactivations: float32[NODES_PER_LAYER]):
...
def get_delta_matrix_weights2(
    ...
    output_difference: float32[NODES_PER_LAYER], last_activations: float32[NODES_PER_LAYER]):
...
def get_oracle_activations1(
    weights2: float32[NODES_PER_LAYER * NODES_PER_LAYER], output_differences: float32[NODES_PER_LAYER],
    oracle_activations: float32[NODES_PER_LAYER], dactivations: float32[NODES_PER_LAYER]):
...
def get_delta_matrix_weights1(
    ...
    output_difference: float32[NODES_PER_LAYER], last_activations: float32[INPUT_DIMENSION]):
...
def update_weights(
    weights1: float32[INPUT_DIMENSION * NODES_PER_LAYER], weights2: float32[NODES_PER_LAYER * NODES_PER_LAYER],
    weights3: float32[NODES_PER_LAYER * POSSIBLE_OUTPUTS], d_weights1: float32[INPUT_DIMENSION * NODES_PER_LAYER],
    d_weights2: float32[NODES_PER_LAYER * NODES_PER_LAYER], d_weights3: float32[NODES_PER_LAYER * POSSIBLE_OUTPUTS],
    biases1: float32[NODES_PER_LAYER], biases2: float32[NODES_PER_LAYER], biases3: float32[POSSIBLE_OUTPUTS],
    d_biases1: float32[NODES_PER_LAYER], d_biases2: float32[NODES_PER_LAYER], d_biases3: float32[POSSIBLE_OUTPUTS]):
    ...
    for i, j in allo.grid(INPUT_DIMENSION, NODES_PER_LAYER):
        weights1[i * NODES_PER_LAYER + j] = weights1[i * NODES_PER_LAYER + j] / norm1_sqrt
    for i in range(NODES_PER_LAYER):
    ...
    for i, j in allo.grid(NODES_PER_LAYER, NODES_PER_LAYER):
        weights2[i * NODES_PER_LAYER + j] = weights2[i * NODES_PER_LAYER + j] / norm2_sqrt
    for i in range(NODES_PER_LAYER):
    ...
    for i, j in allo.grid(NODES_PER_LAYER, POSSIBLE_OUTPUTS):
        weights3[i * POSSIBLE_OUTPUTS + j] = weights3[i * POSSIBLE_OUTPUTS + j] / norm3_sqrt
    for i in range(POSSIBLE_OUTPUTS):
...
def backprop(
    weights1: float32[INPUT_DIMENSION * NODES_PER_LAYER], weights2: float32[NODES_PER_LAYER * NODES_PER_LAYER],
    weights3: float32[NODES_PER_LAYER * POSSIBLE_OUTPUTS], biases1: float32[NODES_PER_LAYER],
    biases2: float32[NODES_PER_LAYER], biases3: float32[POSSIBLE_OUTPUTS],
    training_data: float32[TRAINING_SETS * INPUT_DIMENSION], training_targets: float32[TRAINING_SETS * POSSIBLE_OUTPUTS]):
