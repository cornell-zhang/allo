...
"""
GEMM example with memory annotations for XLS backend testing.

This example demonstrates how to use memory annotations to specify
memory storage types for arrays in the XLS backend.
"""
