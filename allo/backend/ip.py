...
class IPModule:
    def __init__(self, top, headers, impls, signature, include_paths=[], link_hls=True):
        ...
        self.c_wrapper_file = "/scratch/users/hc676/allo/tests/ip_integration/vadd_wrapper.cpp"
    ...
    def compile_shared_lib(self):
        ...
        for src in srcs:
            ...
            src = src.split("/")[-1]
            subcmd += " " + src
            obj = f"/tmp/allo/{src}.o"
            subcmd += " -o " + obj
            print(subcmd)
            subprocess.Popen(subcmd, shell=True).wait()
