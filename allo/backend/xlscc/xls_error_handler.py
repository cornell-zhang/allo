...
"""
XLS Backend Error Handler

Generates detailed diagnostic reports when XLS validation fails,
showing annotated MLIR with error locations and fix suggestions.
"""
...
def generate_diagnostic_report(
    ...
    """
    Generate a detailed diagnostic report from validation errors.
    
    Args:
        errors: List of ValidationError objects
        mlir_text: The full MLIR module text
        context_radius: Number of lines to show before/after each error
...
def write_diagnostic_file(
    ...
    """
    Write a diagnostic file with the error report and full MLIR.
...
def format_error_summary(
    ...
    """
    Format a concise error summary for the exception message.
    
    Args:
        errors: List of ValidationError objects
        project: Optional project path (for diagnostic file reference)
